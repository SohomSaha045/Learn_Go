...
func getOne(movieID string) model.Netflix {
...
func Get_A_Movie(w http.ResponseWriter, r *http.Request) {
	w.Header().Set("Content-Type", "application/json")
	params := mux.Vars(r)
	res:=getOne(params["id"])
...
func Dummy(w http.ResponseWriter, r *http.Request){
	...
	json.NewEncoder(w).Encode("Hi from Server")
}